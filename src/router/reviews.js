...
router.post('/:trackId/reviews', reviewPostValidation, async (req, res) => {
  try {
...
router.get(reviewIdLink, reviewParamValidation, async (req, res) => {
  try {
    validationResult(req).throw();
...
router.put(reviewIdLink, reviewParamValidation, async (req, res) => {
  try {
    validationResult(req).throw();
    const reviewId = req.params.reviewId;
...
router.delete(reviewIdLink, reviewParamValidation, async (req, res) => {
  try {
    validationResult(req).throw();
    const reviewId = req.params.reviewId;
