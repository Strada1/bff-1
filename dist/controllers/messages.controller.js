...
exports.deleteMessage = exports.getMessages = exports.getMessage = void 0;
...
exports.getMessage = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const message = yield messagesService.getMessage(messageId);
    res.status(http_status_1.default.OK).send(message);
}));
...
exports.deleteMessage = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { messageId } = req.params;
    yield messagesService.deleteMessage(messageId);
